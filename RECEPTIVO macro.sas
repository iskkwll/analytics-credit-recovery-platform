...
flag_divida 						TMA 							CHAMADA 						flag_fixa_passivel 
flag_fixa_previa 					aging_max_total 				divida_total 					divida_apos_total 
fl_acordo_amdocs 					fl_acordo_amdocs_convergente 	fl_acordo_amdocs_fixa 			fl_acordo_amdocs_movel 
fl_acordo_atlys 					fl_acordo_kenan 				divida_apos_CONVERGENTE_AMDOCS 	divida_apos_FIXA_AMDOCS 
divida_apos_FIXA_KENAN 				divida_apos_MOVEL_AMDOCS 		divida_apos_MOVEL_ATLYS 		divida_CONVERGENTE_AMDOCS 
divida_FIXA_AMDOCS 					divida_FIXA_KENAN 				divida_MOVEL_AMDOCS 			divida_MOVEL_ATLYS 
aging_max_apos_CONVERGENTE_AMDOC 	aging_max_apos_FIXA_AMDOCS 		aging_max_apos_FIXA_KENAN 		aging_max_apos_MOVEL_AMDOCS 
aging_max_apos_MOVEL_ATLYS 			aging_max_CONVERGENTE_AMDOCS 	aging_max_FIXA_AMDOCS 			aging_max_FIXA_KENAN 
aging_max_MOVEL_AMDOCS 				aging_max_MOVEL_ATLYS			fl_acordo_amdocs_conv_s_log 	fl_acordo_amdocs_fixa_s_log	
fl_acordo_amdocs_movel_s_log 		fl_acordo_amdocs_s_log			fl_quebra_acordo_amd_C_s_log 	fl_quebra_acordo_amd_F_s_log 	
fl_quebra_acordo_amd_M_s_log 		fl_quebra_acordo_amd_C  		fl_quebra_acordo_amd_F  		fl_quebra_acordo_amd_m  
fl_quebra_acordo_atlys  			fl_quebra_acordo_kenan
...
%LET COLUMN3_B2B = KEEP = 
	...
	SEGMENTACAO_FUTURA					documento_num					PESSOA						divida_FIXA_KENAN			
	divida_MOVEL_ATLYS					divida_FIXA_LEGADO				divida_NI_SAP				divida_NI_ATIS				
	divida_NI_MULTA_CONTRATUAL			divida_NI_ATELECOM				divida_NI_PLAT_DIG			divida_apos_FIXA_KENAN		
	divida_apos_MOVEL_ATLYS				divida_apos_FIXA_LEGADO			divida_apos_NI_SAP			divida_apos_NI_ATIS			
	divida_apos_NI_MULTA_CONTRATUAL 	divida_apos_NI_ATELECOM			divida_apos_NI_PLAT_DIG		aging_max_FIXA_KENAN		
	aging_max_MOVEL_ATLYS				aging_max_FIXA_LEGADO			aging_max_NI_SAP			aging_max_NI_ATIS			
	aging_max_NI_MULTA_CONTRATUAL		aging_max_NI_ATELECOM			aging_max_NI_PLAT_DIG		aging_max_apos_FIXA_KENAN	
	aging_max_apos_MOVEL_ATLYS			aging_max_apos_FIXA_LEGADO		aging_max_apos_NI_SAP		aging_max_apos_NI_ATIS		
...
divida_FIXA_KENAN  divida_FIXA_LEGADO  divida_MOVEL_ATLYS divida_NI_ATIS divida_NI_SAP divida_NI_MULTA_CONTRATUAL 
divida_NI_ATELECOM divida_NI_PLAT_DIG divida_apos_FIXA_KENAN divida_apos_FIXA_LEGADO divida_apos_MOVEL_ATLYS 
divida_apos_NI_ATIS divida_apos_NI_SAP divida_apos_NI_MULTA_CONTRATUAL divida_apos_NI_ATELECOM divida_apos_NI_PLAT_DIG 
aging_max_FIXA_KENAN aging_max_FIXA_LEGADO aging_max_MOVEL_ATLYS aging_max_NI_ATIS aging_max_NI_SAP aging_max_NI_MULTA_CONTRATUAL 
aging_max_NI_ATELECOM aging_max_NI_PLAT_DIG aging_max_apos_FIXA_KENAN aging_max_apos_FIXA_LEGADO aging_max_apos_MOVEL_ATLYS 
